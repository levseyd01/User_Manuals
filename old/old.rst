...
- :ref:`Dashboard`
- :ref:`Profile`
- :ref`Contacts & Web Users`
- :ref`Company Documents`
- :ref:`Shareholder Documents`
- :ref`Email History`
...
.. todo::
    Check to see if the note above is still true for TA_Issuer.
...
- :ref:`Manage Shareholders` Screen.
- :ref:`Create Reports` Screen.



.. todo:: find out if the cards on the dashboard are customizable, outside of pressing x.

.. figure:: _static/pdf_images/companyInfo_Dashboard.png
    :alt: Dashboard.
...
Select different folders and Documents.
...
.. figure:: _static/pdf_images/companyInfo_shareholderDocuments_createNewCategory.png
    :alt: *Create New Category* button

    Figure ?? *Add Category* screen appears.

2. Create a *Category Name* in the ``Category Name field``

.. figure:: _static/pdf_images/companyInfo_shareholderDocuments_addCategory.png
...
Upload a Logo for Reports & Certificates Layout
===============================================

1. From the Company Account General screen (Figure 9) click the ``edit icon`` to upload your logo.

Your logo is uploaded into the Logo for Reports & Certificates Layout section.
...
5. To add a title to the left or right side of the certificate, enter the title in the appropriate title field.
...
The security type and certificate associated with it are deleted.
...
1. Verify that the Transaction Date is accurate. The default value is today's date.
...
.. figure:: _static/pdf_images/page_19_image_1.png
    :alt: Company Information, Issue New Reserved Shares screen, Step 1: Basic Information.
...
3. Search for the account/shareholder using the search criteria fields.
    - If you need to add a new account/shareholder, see step 6 a-f (below).
...
Add New Reserve Account
=======================

After selecting the *Add Reserve* button, the *Add New Reserve Account* popup window appears.
...
1. Fill in all required fields.
2. Click **Create** to fill in the Sort Name field.
3. When all required fields are entered, select **Save**.
...
6. When all shareholders have been added, select **Next**.
...
a. Select the payment type from the Payment dropdown list.
b. Select **Finish**.
...
The process automatically updates your certificates with the new company name. When the process is complete the Company History screen displays the previous name effective date and who performed the action.
...
If a shareholder does not have an email address, the shareholder is listed in the "Shareholders Missing Emails" field. You can click on the shareholder and add the email address at this time or add the email later. (See *View Shareholder Details* for more information.)
4. Select **Send Test Email** to (email address).
5. Select **Send** to send the email to the shareholders.

View Shareholder Details
------------------------

* Click the ``view details icon`` next to the shareholder you wish to view.
...
2. Click the view details icon in the shareholder row that you want to view.
   ...
   The *Shareholder Details* screen opens (Figure 37). See View Shareholder
   Details for more information.

Link to Another Shareholder Account
===================================

1. From the Web Account Details screen (Figure 48) click **Link to another Shareholder
   Account**.
...
.. figure:: _static/pdf_images/page_33_image_2.png
    :alt: Company Information, Administrators, List screen.
...
.. figure:: _static/pdf_images/page_36_image_1.png
   :alt: Company Information, Documents for Shareholders screen
...
1. Click **Create New Category**.
   ...
   The **Add Category** popup window opens.
...
1. Click **Document** next to the category.
...
2. If applicable, update the ``Effective Date`` field.
   ...
   If you update the effective date here, it will update the details for all certificates related to this transaction.
...
1. Select **Add Document** in the Transaction Documents section and upload the document from your desktop.
...
.. figure:: _static/pdf_images/page_46_image_2.png
    ...
    Figure 77. Manage Stock, Issue New Shares, Step 3: Pay for Transaction.
...
Use this option to transfer shares. When you select this option, the *Transfer Shares* screen opens and displays six steps.
...
1. Select **Choose** from the *Transfer To* section.
   ...
   .. figure:: _static/pdf_images/page_49_image_1.png
      :alt: The Add Certificate popup window.

      Figure 82. The Add Certificate popup window.
...
2. Click **Select** to select the shareholder.
   ...
   .. figure:: _static/pdf_images/page_49_image_2.png
      :alt: The Select Account/Shareholder popup window.

      Figure 83. The Select Account/Shareholder popup window.

3. Highlight the shareholder and then click **Select**.

   The popup closes and the shareholder is added to the *Select Shareholder* field
   of the *Add Certificate* popup window.
...
5. Select **Issue**.
   ...
   .. figure:: _static/pdf_images/page_49_image_3.png
      :alt: The Tax Lots popup window.

      Figure 84. The Tax Lots popup window.

6. Fill in all required fields.
7. Select **Done**.

   The popup window closes and the shareholder is added to the *Transfer To*
   section.
...
8. Select **Next**.
   ...
   .. figure:: _static/pdf_images/page_50_image_1.png
      ...
      Figure 85. Manage Stock Transfer Stock screen Step 5: Pay for Transaction.

Step 5: Pay for Transaction
^^^^^^^^^^^^^^^^^^^^^^^^^^^

1. Verify that the *Payment* field is correct.
2. If you need to add a new card select **Add New Credit Card** from the drop-down list and
   fill out all required fields in the *Add New Credit Card* popup window.
3. Select **Finish**.
...
.. figure:: _static/pdf_images/page_51_image_1.png
    :alt: Manage Stock Transfer Shares Step 6: Complete Summary.
...
Use this option to convert shares. When you use this option the *Convert Shares* screen opens
and displays five steps.

Make sure to have the certificate that you would like to amend in your possession. Also, make
sure to know the correct conversion rate before you begin this transaction.
...
1. Select **Choose** to choose the certificate to cancel.
   ...
   The *Select Certificate* popup window opens (See Figure 80).
...
.. figure:: _static/pdf_images/page_56_image_1.png
    ...
    Figure 95. Manage Stock, Retire Shares, Step 2: Certificates to Retire.
...
.. note::
    Before you replace any lost certificates we recommend that you contact your attorney
    and/or insurance provider first to ensure that you are acting in the best interests of your
    company.
...
The *Certificates Owned by your Shareholders* screen opens and displays all the
shareholders certificates. This screen allows you to view certificate details, order
certificates, download the status report, and view any securities that are due to
expire.
...
The *Certificate Detail* screen opens. See *View Certificates* for more information on this screen.
...
4. Select **Add**
    ...
    The popup window closes, adn the certificate is added to the Certificates to Print section.
...
- From the *Certificates Owned by your Shareholders* screen (see Figure 99) select **View Current Status Report** and download the report to your desktop.

View Securities Due to Expire
-----------------------------

- From the *Certificates Owned by your Shareholders* screen (see Figure 99) select **View Securities Due to Expire**.
...
1. From the *Certificates Owned by your Shareholders* screen (see Figure 99) select **View Upcoming Exercise Options**.
...
2. Click the **view details icon** in the row that you want to view.
    ...
    The *Certificate Details* screen (see Figure 136) opens and displays the details.
...
.. figure:: _static/pdf_images/page_65_image_3.png
...
.. figure:: _static/pdf_images/page_67_image_1.png
    :alt: Manage Stock Reverse Stock Split overview.
...
.. figure:: _static/pdf_images/page_67_image_3.png
...
.. figure:: _static/pdf_images/page_69_image_3.png
...
The *Add New* popup window opens. This window is based on the type of
proposal selected.

2. Fill in all required fields in the popup window and then select **Save**.

The popup window closes and the proposal information is listed below the
proposal buttons.
...
The *Update Proposal* popup window opens for you to edit the information
or delete the proposal.
...
.. figure:: _static/pdf_images/page_71_image_1.png
    ...
    b. Edit the information by selecting **Save** or click **Delete** to remove the proposal entirely.

4. Select **Next Pay & Publish** to continue with this transaction or select **Save as Draft**
to save the information and come back to it when you are ready to pay and publish the proposal.
...
After modifications, select **Next Pay & Publish** to proceed with the transaction or choose **Save as Draft** to revisit later.

*Next Pay & Publish* leads to Step 3: Pay for Transaction page.

Step 3: Pay for Transaction
^^^^^^^^^^^^^^^^^^^^^^^^^^^

1. Select the payment method from the **Payment** drop-down list.
2. Click **Publish**.

You will now see Step 4: Complete Summary.
...
- Select **View Proxies** to access the Proxies List screen, showcasing your proxies.

.. figure:: _static/pdf_images/page_71_image_3.png
...
.. figure:: _static/pdf_images/page_71_image_4.png
...
If you possess the necessary permissions, you can upload more shareholder lists. This is accessible through the menu if you had previously uploaded a shareholder list upon registration.

Upon selecting this option, the *Upload Shareholders Data Records* screen appears, outlining six steps.

.. figure:: _static/pdf_images/page_73_image_1.png
   :alt: Manage Stock Upload Additional Shareholders Data Records Step 1: Upload Shareholder List File.
...
If the upload was successful, the 100% green bar displays along with the total number of shareholder certificates and shares as shown in the figure below.
...
1. If the company resides outside of the United States select the country from the dropdown list.
...
The Company Account General screen opens. (See General for more information on this screen.)
...
- Click the ``view details icon`` in the row that you want to view.
  ...
  The Certificate Details screen opens. The sections with edit icons are editable. See figure below.
...
.. figure:: _static/pdf_images/page_77_image_3.png
...
3. Select **Save**.
   ...
   The popup window closes and the tax lot is added to the "*Tax Lots*" list.

View Current Status Report
^^^^^^^^^^^^^^^^^^^^^^^^^^

1. From the Certificates Owned by your Shareholders screen (Figure 135) select **View Current Status Report** and download the report to your desktop.
...
Use this option to order certificates. When you select this option the New Order screen opens
and displays three steps.
...
.. figure:: _static/pdf_images/page_81_image_1.png
    ...
    Figure 142. Certificates, Order Certificates, New Order screen, Step 2: Make Payments.
...
.. note:: The actual page numbers and image sequence should be adjusted according to the PDF document.
...
Use this option to view the amount of investment shareholders have within your company.
...
3. Select the appropriate download button (PDF to Excel) to save the report to your desktop.
...
If you have an outstanding balance, the *Invoices List* screen displays the balance. You can
make a partial or full payment on the *Invoices List* screen or open an invoice and make a
payment from there.

.. figure:: _static/pdf_images/page_87_image_1.png
    :alt: Invoices List with an outstanding balance.

    Figure 151. Invoices List with an outstanding balance.
...
.. figure:: _static/pdf_images/page_87_image_3.png
    :alt: Billing Invoices Invoice # screen.
...
5. Select **Save**.
6. Select **Download as PDF** to save the paid invoice to your desktop or select **Back to
   Invoices** to return to the *Invoices List* screen.
...
.. figure:: _static/pdf_images/page_x_image_1.png
...
.. figure:: _static/pdf_images/page_x_image_2.png
...
.. figure:: _static/pdf_images/page_x_image_3.png
...
.. figure:: _static/pdf_images/page_x_image_4.png
...
.. figure:: _static/pdf_images/page_x_image_5.png
    :alt: Example of logged issue.

    Figure 162. Example of logged issue.
To view a response to your issue click the view details icon in the row that you want to view.
...
.. figure:: _static/pdf_images/page_xx_image_1.png
   :align: center
